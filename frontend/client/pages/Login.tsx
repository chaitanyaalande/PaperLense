    ...
    <div className="min-h-screen bg-background text-foreground flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-slate-900 flex-col items-center justify-center p-12">
        <div className="max-w-md text-center">
          ...
          <h1 className="text-4xl font-bold text-white mb-4">Scanify</h1>
          <p className="text-slate-400 text-lg leading-relaxed">
            AI-Powered Handwritten Document Digitization & Classification
          </p>
          <div className="mt-12 space-y-4">
            {["Upload handwritten documents", "Extract text with AI OCR", "Auto-classify by document type", "Download & manage your files"].map((feat) => (
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <p className="text-muted-foreground mb-8">Sign in to your Scanify account</p>
          ...
          <p className="mt-6 text-center text-muted-foreground text-sm">
            ...
            <Link to="/register" className="text-purple-500 hover:text-purple-400 font-semibold transition">
              Create one
            </Link>
          </p>
        </div>
